# -*- coding: utf-8 -*-
"""每日 9:25 拉取年报（前一交易日），含 backfill 统计。"""
...
SCHEDULER_JOB_KEY = "rq_yearly"


def run() -> JobResult:
    from rq_paths import bootstrap

    bootstrap(str(_ROOT / "bench_quarterly_yearly" / "MasterData" / "data_rq" / "update_daily_rq_yearly.py"))
